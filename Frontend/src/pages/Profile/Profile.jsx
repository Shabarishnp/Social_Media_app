                ...
                <>
                  {editMode ? (
                    <>
                      <button
                        onClick={handleSave}
                        className="bg-violet-500 mt-2.5 px-5 py-2 text-white rounded-md hover:bg-green-700 transition"
                      >
                        {loading ? "Saving Changes" : "Save Changes"}
                      </button>
                      <button
                        onClick={handleCancel}
                        className="bg-gray-500 mt-2.5 px-5 py-2 text-white rounded-md hover:bg-red-600 transition"
                      >
                        Cancel
                      </button>
                    </>
                    ...
                    <>
                      <label
                        ...
                        className="text-white self-center cursor-pointer bg-gray-600 mt-2.5 px-5 py-2 rounded-md hover:bg-green-700 transition"
                      >
                        Edit Profile
                      </label>
                      <input
